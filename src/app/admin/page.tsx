...
import {
  AlertTriangle, ArrowRight, ArrowUpRight, Check, CheckCircle2, Clock3, Copy,
      ...
      <div className="admin-operations pathline-grid min-h-0 flex-1 bg-[#F1F5F2] p-[clamp(.75rem,1.15vw,2.5rem)] text-[#071A2D]">
        <div className="mx-auto w-full max-w-[1920px] space-y-[clamp(1rem,1vw,1.75rem)]">
          <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
            ...
            <div className="flex gap-2"><label className="relative flex-1 xl:w-[clamp(360px,24vw,520px)]"><Search className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#071A2D]/35"/><input className="h-12 w-full rounded-2xl border border-[#071A2D]/9 bg-white pl-12 pr-4 text-sm shadow-sm outline-none focus:border-[#2775CA] 2xl:h-14" placeholder="Referencia, cliente o wallet"/></label><button className="grid h-12 w-12 place-items-center rounded-2xl border border-[#071A2D]/9 bg-white shadow-sm 2xl:h-14 2xl:w-14" aria-label="Filtros"><Filter className="h-5 w-5"/></button></div>
          </div>
